...
if weight >= 110 and age >= 16:
    ...
    print('Sorry, you do not weight enough. For the safety of donors, you must weight at least 110')
else:
    print('Sorry, you are too young and do not weigh enough to give blood.')
    print('Please come back when you are 16 or older, and weigh at least 110 pounds')